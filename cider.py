...
def getGTCaptions(annotations):
    ...
    for item in annotations:
        ...
        #output_sentence = item['output_sentence']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pred_file",default='/home/peihsin/Sinica/emnlp_scl_5_345.json', help="Prediction json file")
    parser.add_argument("--annotation_file", default="/home/peihsin/Sinica/dataset/output_test_label_para6.pkl", help="Annotation json file")
